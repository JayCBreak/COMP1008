...
public class Student {
    ...
    /**
     * Create a Student with the given name, age and grade.
     * @param name String variable representing the name of the student. Min 3 characters.
     * @param age Integer variable representing the age of the student. Between 18 and 100 years old inclusive.
     * @param grade Double variable representing the current grade. Between 20 and 100 inclusive.
     */
...
//        this.age = age;
    ...
    /**
     * Gets the age of the student object.
     * @return Integer variable representing age.
     */
    public int getAge() {
        return age;
    }
     ...
     * @param age Integer variable representing age. Must be between 18 and 100 inclusive.
     */
     ...
     * @param grade double value of grade between 20 and 100
